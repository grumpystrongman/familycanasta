...
const GAME_CATALOG = [
  ...
  { id: "chess", name: "Chess", icon: "♚", eyebrow: "Pure strategy", description: "Full legal chess with check, checkmate, castling, en passant, stalemate, and a quick robot opponent.", players: "2 players", status: "Ready" },
  { id: "checkers", name: "Checkers", icon: "⛀", eyebrow: "Jump · crown · trap", description: "American checkers with mandatory captures, chained jumps, kings, online rooms, and robot play.", players: "2 players", status: "Ready" },
  { id: "lexiconforge", name: "Lexicon Forge", icon: "⚒", eyebrow: "Build words · claim premiums", description: "Original word-tile strategy with seven-tile racks, cross-word scoring, exchanges, custom tile math, and house-rule word challenges.", players: "2–4 players", status: "Ready" },
  { id: "bloodalibi", name: "Blackglass: Blood & Alibi", icon: "🩸", eyebrow: "Modern murder mystery", description: "A darker deduction case with six original suspects, nine crime scenes, brutal methods, evidence files, and final accusations.", players: "2–6 investigators", status: "Ready" },
