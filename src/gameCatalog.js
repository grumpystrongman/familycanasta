...
export const GAME_CATALOG = [
  ...
  { id: "arcade", category: "arcade", name: "Browser Arcade", icon: "🕹️", eyebrow: "80s & 90s coin-op classics", description: "A browser arcade cabinet with FinalBurn Neo recommended for the curated library, a MAME 2003 option for compatible older sets, local ROM loading, and rights-approved free ROM sources.", players: "1–2 local players", status: "Ready" },
